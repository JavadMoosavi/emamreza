        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/caravanHomeInfo" class="nav-link active">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-left">
                                ...
                                <li class="breadcrumb-item active">مشاهده مشخصات اسکان</li>
                            </ol>
                        </div>
                        <div class="col-sm-6">
                            <h1 class=" float-sm-right">مشاهده مشخصات اسکان</h1>
                        </div>
            ...
            <section class="content">
                ...
                <div class="card pilgrim_card_box">
                    <div class="card-header bg-info">
                        ...
                        <h3 class="card-title float-right">مشخصات اسکان</h3>
                    </div>
                    <div class="card-body text-right" dir="rtl">

                        @if($man_Home == '0' || $woman_Home == '0')
                        تا کنون اسکانی به این کاروان تخصیص نیافته است.<br />
                        به محض فعال شدن اسکان، جزئیات در همین صفحه نمایش داده خواهد شد.
                        @else
                        <p><strong>
                        ...
                        <p>
                            ...
                            نام مدیر اسکان:
                            {{ $man_Home -> home_admin_name }} {{ $man_Home -> home_admin_family }}
                        </p>
                        ...
                        <p>
                            ...
                            نام مدیر اسکان:
                            {{ $woman_Home -> home_admin_name }} {{ $woman_Home -> home_admin_family }}
                        </p>
