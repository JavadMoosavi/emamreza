    ...
    <header class="bg-primary bg-gradient text-white">
        <div class="container px-4 text-center">
            ...
            <h6 class="mb-5">بسم الله الرحمن الرحیم</h3>
                ...
                <p class="lead">به سامانه ثبت نام کاروان ها خوش آمدید. لطفا مشخصات خواسته شده را به دقت در فرم زیر ثبت نمایید</p>
        ...
        <div class="container px-4">
            <div class="row gx-4 justify-content-center">
                <p class="row justify-content-center">
                    این فرم صرفا مخصوص ثبت مشخصات مدیر کاروان است.
                <br/>    
                ...
                <div class="row justify-content-center col-lg-8">
                    <div class="col-lg-4 md-4 justify-content-center mb-3">
                        <label for="melli" class="form-label">* کد ملی مدیر  کاروان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="name" class="form-label">* نام مدیر کاروان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="family" class="form-label">* نام خانوادگی مدیر کاروان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="sex" class="form-label">* جنسیت مدیر کاروان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="fathername" class="form-label">* نام پدر مدیر کاروان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="shenasname" class="form-label">* شماره شناسنامه مدیر کاروان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="birthday" class="form-label">* تاریخ تولد مدیر کاروان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="education" class="form-label">* تحصیلات مدیر کاروان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="caravan" class="form-label">* نام کاروان</label>
                        <input type="text" class="form-control" id="caravan" onblur="validate_caravan()" placeholder="">
                    </div>
                </div>

                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="province" class="form-label">* آدرس مدیر کاروان - استان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="city" class="form-label">* آدرس مدیر کاروان - شهرستان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="village" class="form-label">آدرس مدیر کاروان - نام روستا / دهستان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="address" class="form-label">* ادامه آدرس مدیر کاروان</label>
                        <input type="text" class="form-control" id="address" onblur="validate_address()" placeholder="خیابان، پلاک، طبقه و ...">
                    </div>
                </div>

                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="zipcode" class="form-label">* کد پستی مدیر کاروان</label>
                        <input type="text" class="form-control" id="zipcode" onblur="validate_zipcode()" placeholder="کد پستی ده رقمی">
                    </div>
                </div>

                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="mobile" class="form-label">* تلفن همراه مدیر کاروان</label>
                ...
                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="phone" class="form-label">* تلفن ثابت مدیر کاروان</label>
                        <input type="text" class="form-control" id="phone" placeholder="تلفن با کد شهر" onblur="validate_phone()">
                    </div>
                </div>

                <div class="row justify-content-center col-lg-8 my-3">
                    <div class="col-lg-4 md-4 justify-content-center">
                        <label for="email" class="form-label">ایمیل مدیر کاروان</label>
                        <input type="text" class="form-control" id="email" placeholder="یک ایمیل معتبر وارد کنید">
                        <span>فقط در صورتی که ایمیل دارید، آن را وارد نمایید. جزئیات کاری از طریق ایمیل ارسال می گردد.</span>
                    </div>
                </div>
